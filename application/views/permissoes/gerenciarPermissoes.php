        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <a href="<?php echo base_url(); ?>index.php/permissoes/add" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar Permissão</a>
                        <br>
                        <br>
                        <?php if (!$results) { ?>
                                    ...
                                    <table class="table table-bordered ">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($results as $r) {
                                                ...
                                                echo '<td>' . $situacao . '</td>';
                                                echo '<td>
                      <a href="' . base_url() . 'index.php/permissoes/editar/' . $r->idPermissao . '" class="btn btn-info tip-top">Editar Permissão<i class="icon-pencil icon-white"></i></a>
                      <a href="#modal-excluir" role="button" data-toggle="modal" permissao="' . $r->idPermissao . '" class="btn btn-danger tip-top" >Desativar Permissão<i class="icon-remove icon-white"></i></a>
                  </td>';
                                                echo '</tr>';
                                            }
                                            ?>
