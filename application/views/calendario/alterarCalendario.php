                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group text-left">
                                ...
                                <a title="cancelar" href="<?php echo base_url() ?>index.php/calendario" class="btn btn-primary btn-small">CANCELAR </a>
        ...
        $(document).on('click', 'span', function (event) {
            ...
            if ((id % 1) == 0) {
                $.ajax({
                    ...
                    {
                        if (data.result == true) {
                            window.location.href = "<?php echo base_url(); ?>./index.php/calendario";
                        } else {
