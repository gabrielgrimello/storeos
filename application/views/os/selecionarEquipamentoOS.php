    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success" >
                ...
                <div class="box-body">
                    <form action="<?php echo base_url() ?>index.php/os/salvarOSNovoEquipamento" method="post">
                        ...
                        <table class="table table-bordered table-hover table-striped table-condensed">
                            ...
                            <tbody>
                                ...
                                foreach ($equipamentosCliente as $e) {
                                    ...
                                    echo '<td>'
                                    . ' <form action="' . base_url() . 'index.php/os/salvarOSEquipamentoSelecionado" method="post">
                                            <input type="hidden" class="form-control" name="codigoCliente" id="codigoCliente" value="' . $codigoCliente . '">
