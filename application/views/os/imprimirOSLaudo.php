...
<section class="content-header">
    <div class="col-xs-12">
        ...
        <div class="col-xs-3 text-right">
            <a title="editar" href="<?php echo base_url() ?>index.php/os/alterarOS/<?php echo $OS->idOS; ?>" class="btn btn-primary btn-lg">Editar <i class="fa-fw glyphicon glyphicon-edit"></i> </a>
